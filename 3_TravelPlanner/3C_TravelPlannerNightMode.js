function setNightModeStyle() {
  ...
  if (themeLink) {
    themeLink.setAttribute("href", "3B_TravelPlannerNightMode.css");
  }
}
...
function removeNightModeStyle() {
  const themeLink = document.getElementById("theme-style");
  if (themeLink) {
    themeLink.setAttribute("href", "3B_TravelPlanner.css");
  }
}

function toggleNightMode() {
    const currentTheme = document.getElementById("theme-style").getAttribute("href");
    const lightTheme = "3B_TravelPlanner.css";
    const darkTheme = "3B_TravelPlannerNightMode.css";
