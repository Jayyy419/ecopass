function setNightModeStyle() {
  ...
  if (themeLink) {
    themeLink.setAttribute("href", "5B_CommunityForumNightMode.css");
  }
}
...
function removeNightModeStyle() {
  const themeLink = document.getElementById("theme-style");
  if (themeLink) {
    themeLink.setAttribute("href", "5B_CommunityForum.css");
  }
}

function toggleNightMode() {
    const currentTheme = document.getElementById("theme-style").getAttribute("href");
    const lightTheme = "5B_CommunityForum.css";
    const darkTheme = "5B_CommunityForumNightMode.css";
