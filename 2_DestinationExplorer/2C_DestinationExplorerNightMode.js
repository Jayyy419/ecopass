function setNightModeStyle() {
  ...
  if (themeLink) {
    themeLink.setAttribute("href", "2B_DestinationExplorerNightMode.css");
  }
}
...
function removeNightModeStyle() {
  const themeLink = document.getElementById("theme-style");
  if (themeLink) {
    themeLink.setAttribute("href", "2B_DestinationExplorer.css");
  }
}

function toggleNightMode() {
    const currentTheme = document.getElementById("theme-style").getAttribute("href");
    const lightTheme = "2B_DestinationExplorer.css";
    const darkTheme = "2B_DestinationExplorerNightMode.css";
